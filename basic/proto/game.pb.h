...
class req_login : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pt.req_login) */ {
 public:
  req_login();
  virtual ~req_login();
 ...
 private:
  ...
  friend void ::protobuf_game_2eproto::InitDefaultsreq_loginImpl();
};
// ===================================================================
